...
export interface WorkProgressTemplateRepository {
  ...
  addItem(templateId: string, data: CreateTemplateItemData): Promise<WorkProgressTemplateItem>
  updateItem(itemId: string, data: UpdateTemplateItemData): Promise<WorkProgressTemplateItem>
  ...
  addItemSubtask(itemId: string, data: TemplateSubtaskSeed): Promise<WorkProgressTemplateSubtask>
  updateItemSubtask(
    subtaskId: string,
    data: { title?: string; orderIndex?: number },
  ): Promise<WorkProgressTemplateSubtask>
  deleteItemSubtask(subtaskId: string): Promise<void>
  findItemSubtaskById(subtaskId: string): Promise<
    | (WorkProgressTemplateSubtask & {
    ...
    | null
  >
  replaceItemSubtasks(itemId: string, subtasks: readonly TemplateSubtaskSeed[]): Promise<void>
}
