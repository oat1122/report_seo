...
export function updatePlanUseCase(
  ...
  return async (
    ...
    await activityRepo.log({
      ...
      entityId: planId,
      diff: {
        before: { title: plan.title, packageName: plan.packageName, note: plan.note, startDate: plan.startDate, endDate: plan.endDate },
        after: { title: updated.title, packageName: updated.packageName, note: updated.note, startDate: updated.startDate, endDate: updated.endDate },
      },
    });
    return updated;
  };
