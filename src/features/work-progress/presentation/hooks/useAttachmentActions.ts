...
export const useUploadAttachment = () => {
  ...
  return useMutation<unknown, Error, AttachCtx & { file: File; caption?: string | null }>({
...
export const useAddLinkAttachment = () => {
  const invalidate = useInvalidate()
  return useMutation<unknown, Error, AttachCtx & { body: AddLinkAttachmentInput }>({
...
export const useDeleteAttachment = () => {
  const invalidate = useInvalidate()
  return useMutation<void, Error, AttachCtx & { attachmentId: string }>({
