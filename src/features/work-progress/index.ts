...
// Plan
export const createPlan = createPlanUseCase(repo, masterRepo, templateRepo, activityRepo)
...
export const bulkUpdateItemStatus = bulkUpdateItemStatusUseCase(repo, masterRepo, activityRepo)
export const bulkDeleteItems = bulkDeleteItemsUseCase(repo, activityRepo)

// Mark
export const setPeriodMark = setPeriodMarkUseCase(repo, masterRepo, activityRepo)
...
export const updateTemplateItem = updateTemplateItemUseCase(templateRepo, masterRepo)
export const deleteTemplateItem = deleteTemplateItemUseCase(templateRepo)

// Phase 3 — Rich Items
export const addSubtask = addSubtaskUseCase(repo, subtaskRepo, lookupAssignee, activityRepo)
export const updateSubtask = updateSubtaskUseCase(repo, subtaskRepo, lookupAssignee, activityRepo)
export const toggleSubtask = toggleSubtaskUseCase(repo, subtaskRepo, activityRepo)
export const reorderSubtasks = reorderSubtasksUseCase(repo, subtaskRepo, activityRepo)
export const deleteSubtask = deleteSubtaskUseCase(repo, subtaskRepo, activityRepo)
...
export const addLinkAttachment = addLinkAttachmentUseCase(repo, attachmentRepo, activityRepo)
...
// Phase 4 — Audit & Insights
export const getDashboardSummary = getDashboardSummaryUseCase(repo, activityRepo)
...
export type { WorkProgressItem, WorkProgressItemPeriodMark } from './domain/WorkProgressItem'
...
export type { WorkProgressAttachment, AttachmentKind } from './domain/WorkProgressAttachment'
