...
const UPLOAD_CATEGORY = 'keyword-evidence' as const
...
export class LocalKeywordEvidenceStorage implements ImageStorage {
  async validateAndWrite(files: File[]): Promise<SavedImage[]> {
    ...
    try {
      ...
      // write ล้มกลางทาง — ลบรูปที่เพิ่งเขียนไปแล้วก่อน rethrow
