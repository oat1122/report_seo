...
import { MAX_AI_OVERVIEW_IMAGES, type AiOverviewUpdateInput } from '../../schemas'
import type { AiOverviewRepository } from '../ports/AiOverviewRepository'
import type { ImageStorage } from '../ports/ImageStorage'

export function updateAiOverviewUseCase(repo: AiOverviewRepository, storage: ImageStorage) {
  return async (
