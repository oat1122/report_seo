...
import { bulkDeleteItems, bulkDeleteItemsSchema } from '@/features/work-progress'
...
export const POST = withApiHandler(
  ...
  async ({ params, body, session }) => {
    ...
    return ok(await bulkDeleteItems(ctx.customer.id, params.planId, session.user.id, body))
  },
)
